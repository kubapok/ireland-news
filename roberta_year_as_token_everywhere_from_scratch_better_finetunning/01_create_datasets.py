...
with open('../test-A/in.tsv','r') as f_in, open(f'../test-A/huggingface_format_year_clear.csv', 'w') as f_hf:
...
for dataset in 'train', 'dev-0':
    with open(f'../{dataset}/in.tsv') as f_in, open(f'../{dataset}/expected.tsv') as f_exp, open(f'../{dataset}/huggingface_format_year_clear.csv','w') as f_hf:
        f_hf.write('text\tyear_cont\tdate\tday_of_year\tday_of_month\tmonth\tyear\tweekday\tlabel\n')
